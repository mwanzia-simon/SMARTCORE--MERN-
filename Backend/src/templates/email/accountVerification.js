export const accountVerificationTemplate = ({ name, link, year }) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Verify Your SmartCore Account</title>
</head>
        ...
        <table width="320" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff;border-radius:10px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:40px 30px;color:#333333;">
              ...
              <p style="font-size:16px;line-height:1.7;">
                Welcome to <strong>SmartCore</strong>! Please verify your email
                address to activate your account and start shopping.
              </p>
              ...
              <p style="font-size:14px;color:#777777;">
                If you didn't create a SmartCore account, you can safely ignore
                this email.
              </p>
          ...
          <!-- Footer -->
          <tr>
            <td align="center" style="background:#f8f8f8;padding:20px;color:#888888;font-size:13px;">
